...
export type { FileIconProps } from "./components/file-icon.tsx";
export { FileIcon } from "./components/file-icon.tsx";
...
export type { HeroIconProps, HeroIconVariant } from "./components/heroic-icon.tsx";
export { HeroIcon } from "./components/heroic-icon.tsx";
