...
import { ComboboxWidget } from "./controls/combobox.ts";
import { DatePickerWidget } from "./controls/date-picker.ts";
...
import { DevToolsHighlightWidget } from "./devtools/highlight.ts";
import { BannerWidget } from "./feedback/banner.ts";
import { GaugeWidget } from "./feedback/gauge.ts";
...
registerElement("ztui-devtools-highlight", () => new DevToolsHighlightWidget());
...
registerElement("ztui-description-list", () => new DescriptionListWidget());
...
registerElement("ztui-combobox", () => new ComboboxWidget());
registerElement("ztui-date-picker", () => new DatePickerWidget());
